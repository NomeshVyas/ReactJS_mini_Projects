...
import { Card, Form, Input, Watermark, Select } from "antd";
          ...
          title={
            <h2>
              <img
                ...
                alt=""
              />{" "}
              <span style={{ color: "#4d4d4d" }}>Crypto Converter</span>
            </h2>
          }
        >
          <Form>
          ...
          <p className="resultPara">
            {inputValue === "" ? 0 : inputValue} {firstSelect}{" "}
            <span className="result-span">=</span> {result} {secondSelect}
          </p>
        </Card>
      </div>
    </Watermark>
